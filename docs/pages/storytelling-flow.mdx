...
Current scope: intake expects UTF-8 text content. Native OCR for scanned/image/PDF files is not implemented yet.

## How It Works (Big Picture)

![End-to-end intake flow diagram](/diagrams/intake-flow-sequence.svg)

Flow source files:
- `docs/diagrams/intake-flow-sequence.drawio` (editable Draw.io XML)
- `docs/public/diagrams/intake-flow-sequence.svg` (rendered in docs)

Architecture diagram:

![Event-driven architecture diagram](/diagrams/intake-architecture.svg)

Source files:
- `docs/diagrams/intake-architecture.drawio` (editable Draw.io XML)
- `docs/public/diagrams/intake-architecture.svg` (rendered in docs)
